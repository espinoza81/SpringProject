...
public class PartnerController {
    ...
    public String dogsForStud(Model model,
        ...
        List<DogWithNameIdDTO> dogsOwnerForStud = this.dogService.getDogsSex(user.getUsername(), SexEnum.M);
        List<DogWithNameIdDTO> dogsOwnerSexF = this.dogService.getDogsSex(user.getUsername(), SexEnum.F);
    ...
    public String breedSingleDog(@Valid BreedingIdsDTO breedingIdsDTO,
        ...
        Long puppy = this.dogService.breedDog(breedingIdsDTO, user.getUsername());
